...
public class LLGenericOpenFlowSocket extends ChannelInboundHandlerAdapter implements ILowerLayerSocket {
	...
	public LLGenericOpenFlowSocket(LowerOpenFlowEndpoint endpoint, Channel channel) {
	...
	public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
		...
		if (tvMessage.isOpenFlow()) {
			logger.debug("Received {} message from {}", tvMessage.getOFMessage().getType(), ctx.channel().remoteAddress());
	...
	public void send(TVMessage tvMessage) {
		logger.debug("Sent {} message to {}", tvMessage.getOFMessage().getType(), channel.remoteAddress());
